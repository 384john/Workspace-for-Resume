...
import com.nyulink.adapter.MyListAdapter_children;
import com.nyulink.info.VoiceInfo;
import com.nyulink.info.ChildInfo;
...
public class UserInfoActivity extends Activity {
	...
	private ImageView mUserMore, mUserCamera, mBack;
	...
	private TextView SendMessage, UserName, UserAge, UserHobbies, UserPlace,
			UserExplain, UserTime, UserBrand, userinfo, Uemail, uFacebook, mUserRevise;
...
//		Detail_List_children.setAdapter(mAdapter_children);
		...
		mAdapter = new VoiceListAdapter(UserInfoActivity.this, list);
...
//		mSendMsgLayout = (RelativeLayout) findViewById(R.id.sendmsg_layout);
		mUserRevise = (TextView) findViewById(R.id.UserRevise);
...
//		Detail_CommentsNum_children = (RelativeLayout) findViewById(R.id.usernochildren);
		...
		TypefaceHelper.typeface(mUserRevise, tfInit.Bold());
		TypefaceHelper.typeface(UserName, tfInit.Bold());
		TypefaceHelper.typeface(UserAge, tfInit.Regular());
		TypefaceHelper.typeface(Uemail, tfInit.Regular());
		TypefaceHelper.typeface(userinfo, tfInit.LightItalic());
